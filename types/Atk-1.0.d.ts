    ...
    namespace Atk {
        ...
        namespace Document {
            interface SignalSignatures  {
                 ...
                 * @since 2.52
                 * @param arg1 the name of the attribute being modified, or %NULL if not
                         available.
                 ...
                 * viewer.
                 * @since 2.12
                 * @param page_number the new page number. If this value is unknown
        ...
        const HyperlinkImpl: HyperlinkImplIface
        ...
        const ImplementorIface: ImplementorIfaceIface
        ...
        const StreamableContent: StreamableContentIface
        ...
        namespace Value {
            interface SignalSignatures  {
                 ...
                 * @param text human readable text alternative (also called
            ...
            interface Interface  {
                 ...
                 */
                vfunc_get_value_and_text(): number
                /**
        ...
        const GObjectAccessible: GObjectAccessibleClass
        ...
        namespace Object {
            interface SignalSignatures extends GObject.Object.SignalSignatures {
                 ...
                 * "remove"
                 * @param arg1 The index of the added or removed child. The value can be
                -1. This is used if the value is not known by the implementor
                when the child is added/removed or irrelevant.
                 * @param arg2 A gpointer to the child AtkObject which was added or
                 ...
                 * @param arg1 a boolean value which indicates whether the object gained
                or lost focus.
                 */
                 ...
                 * @since 2.50
                 * @param arg1 the text to be announced.
                 * @param arg2 an #AtkLive specifying the politeness of the notification.
                 ...
                 * @param arg1 an #AtkPropertyValues containing the new
        ...
        const ObjectFactory: ObjectFactoryClass
        ...
        interface RelationClass extends Omit<GObject.ObjectClass, "new"> {
             ...
             * @param targets an array of pointers to
             #AtkObjects
             * @param relationship an #AtkRelationType with which to create the new
             #AtkRelation
        ...
        const RelationSet: RelationSetClass
        ...
        abstract class Implementor {
            static readonly $gtype: GObject.GType<Implementor>
         ...
         */
        abstract class KeyEventStruct {
            static readonly $gtype: GObject.GType<KeyEventStruct>
         ...
         */
        abstract class PropertyValues {
            static readonly $gtype: GObject.GType<PropertyValues>
         ...
         */
        abstract class TextRectangle {
            static readonly $gtype: GObject.GType<TextRectangle>
        ...
        const BINARY_AGE: 26000
        const INTERFACE_AGE: 1
        const MAJOR_VERSION: 2
        const MICRO_VERSION: 90
        const MINOR_VERSION: 59
        ...
        namespace Layer {
            const $gtype: GObject.GType<Layer>
        }
         ...
         * @returns the #AtkRelationType enumerated type corresponding to the specified name,          or #ATK_RELATION_NULL if no matching relation type is found.
         */
        function for_name(name: string): RelationType
        /**
         * Gets the description string describing the #AtkRelationType @type.
         * @param type The #AtkRelationType whose name is required
         * @returns the string describing the AtkRelationType
         */
        function get_name(type: RelationType): string
        /**
         * Associate @name with a new #AtkRelationType
         * @param name a name string
         * @returns an #AtkRelationType associated with `name`
         */
        function register(name: string): RelationType
         ...
         * @returns the #AtkRole enumerated type corresponding to the specified name,          or #ATK_ROLE_INVALID if no matching role is found.
         */
        function for_name(name: string): Role
        /**
         * Gets the localized description string describing the #AtkRole @role.
         * @param role The #AtkRole whose localized name is required
         * @returns the localized string describing the AtkRole
         ...
         * @returns an #AtkRole for the new role if added properly. ATK_ROLE_INVALID in case of error.
         */
        function register(name: string): Role
         ...
         * @returns an #AtkStateType corresponding to `name`
         */
        function for_name(name: string): StateType
        /**
         * Gets the description string describing the #AtkStateType @type.
         * @param type The #AtkStateType whose name is required
         * @returns the string describing the AtkStateType
         */
        function get_name(type: StateType): string
        /**
         * Register a new object state.
         * @param name a character string describing the new state.
         * @returns an #AtkState value for the new state.
         */
        function register(name: string): StateType
        
        namespace TextAttribute {
            const $gtype: GObject.GType<TextAttribute>
        }
         ...
         * @returns the #AtkTextAttribute enumerated type corresponding to the specified          name, or #ATK_TEXT_ATTRIBUTE_INVALID if no matching text attribute          is found.
         */
        function for_name(name: string): TextAttribute
        /**
         * Gets the name corresponding to the #AtkTextAttribute
         * @param attr The #AtkTextAttribute whose name is required
         * @returns a string containing the name; this string should not be freed
         */
        function get_name(attr: TextAttribute): string
        /**
         * Gets the value for the index of the #AtkTextAttribute
         * @param attr The #AtkTextAttribute for which a value is required
         * @param index_ The index of the required value
         * @returns a string containing the value; this string should not be freed; %NULL is returned if there are no values maintained for the attr value.
         */
        function get_value(attr: TextAttribute, index_: number): string | null
        /**
         * Associate @name with a new #AtkTextAttribute
         * @param name a name string
         * @returns an #AtkTextAttribute associated with `name`
         */
        function register(name: string): TextAttribute
        
        namespace TextBoundary {
            const $gtype: GObject.GType<TextBoundary>
        }
        ...
        namespace ValueType {
            const $gtype: GObject.GType<ValueType>
        }
         ...
         * @returns the localized string describing the #AtkValueType
         */
        function get_localized_name(value_type: ValueType): string
        /**
         * Gets the description string describing the #AtkValueType @value_type.
         * @param value_type The #AtkValueType whose name is required
         * @returns the string describing the #AtkValueType
         */
        function get_name(value_type: ValueType): string
        
        namespace HyperlinkStateFlags {
            const $gtype: GObject.GType<HyperlinkStateFlags>
        }
