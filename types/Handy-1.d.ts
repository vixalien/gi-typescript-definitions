...
declare module "gi://Handy?version=1" {
    ...
    namespace Handy {
        ...
        interface Avatar extends Gtk.DrawingArea, Atk.ImplementorIface, Gtk.Buildable {
             ...
             * @param callback a [callback@Gio.AsyncReadyCallback] to call when
             ...
             * @since 1.0
             * @deprecated since 1.2 use [method@Avatar.set_loadable_icon] instead.
        ...
        interface ComboRow extends ActionRow, Atk.ImplementorIface, Gtk.Actionable, Gtk.Buildable {
             ...
             * @param create_list_widget_func a function that creates
              widgets for items to display in the list, or `NULL` in case you also passed
              `NULL` as @model
             * @param create_current_widget_func a function that creates
             ...
             * @since 1.0
             * @param model the [iface@Gio.ListModel] to be bound to @self
             * @param get_name_func a function that creates names for items, or
        ...
        interface HeaderGroup extends GObject.Object, Gtk.Buildable {
             ...
             * decoration.
             * @since 1.0
             * @param decorate_all whether the elements of the group should all receive the full
              decoration
             */
        ...
        namespace SwipeTracker {
            interface SignalSignatures extends GObject.Object.SignalSignatures, Gtk.Orientable.SignalSignatures {
                 ...
                 * @param direct `TRUE` if the swipe is directly triggered by a gesture,
        ...
        namespace TabView {
            interface SignalSignatures extends Gtk.Bin.SignalSignatures, Atk.ImplementorIface.SignalSignatures, Gtk.Buildable.SignalSignatures {
                 ...
                 * @since 1.2
                 * @returns the [class@TabView] from the new   window
                 */
