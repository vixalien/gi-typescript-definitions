...
declare module "gi://GLibUnix?version=2.0" {
    ...
    namespace GLibUnix {
         ...
         */
        abstract class Pipe {
            static readonly $gtype: GObject.GType<Pipe>
         ...
         */
        function fd_add_full(priority: number, fd: number, condition: GLib.IOCondition, func: FDSourceFunc): number
        /**
         ...
         */
        function get_passwd_entry(user_name: string): never | null
        /**
        ...
        namespace PipeEnd {
            const $gtype: GObject.GType<PipeEnd>
        }
