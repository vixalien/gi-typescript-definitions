...
declare module "gi://GstBase?version=1.0" {
    ...
    namespace GstBase {
        ...
        interface BaseParse extends Gst.Element {
             ...
             * @param min_size Minimum size in bytes of the data that this base class should
                  give to subclass.
             */
        ...
        interface BaseSrc extends Gst.Element {
             ...
             * @returns , 
             */
            vfunc_create(offset: number, size: number): [Gst.FlowReturn, Gst.Buffer | null]
            /**
             * configure the allocation query
             * @param query
             */
        ...
        interface CollectPads extends Gst.Object {
             ...
             * @param destroy_notify function to be called before the returned
        ...
        interface PushSrc extends BaseSrc {
             ...
             * @returns , 
             */
            vfunc_create(): [Gst.FlowReturn, Gst.Buffer | null]
            /**
