...
declare module "gi://Gcr?version=3" {
    ...
    namespace Gcr {
        ...
        namespace Certificate {
            ...
            interface ReadableProperties extends Comparable.ReadableProperties {
                "description": string
                "expiry": GLib.Date
                "icon": Gio.Icon
                "issuer": string
            ...
            interface WritableProperties extends Comparable.WritableProperties {
                "description": string
                "expiry": GLib.Date
                "icon": Gio.Icon
                "issuer": string
        ...
        const ImportInteraction: ImportInteractionIface
        ...
        namespace FilterCollection {
            ...
            interface ReadableProperties extends GObject.Object.ReadableProperties, Collection.ReadableProperties {
                "underlying": Collection
            }

            interface WritableProperties extends GObject.Object.WritableProperties, Collection.WritableProperties {
                "underlying": Collection
            }
        ...
        const FilterCollection: FilterCollectionClass
        ...
        namespace Pkcs11Certificate {
            ...
            interface ReadableProperties extends Gck.Object.ReadableProperties, Certificate.ReadableProperties, Comparable.ReadableProperties {
                "attributes": Gck.Attributes
            }

            interface WritableProperties extends Gck.Object.WritableProperties, Certificate.WritableProperties, Comparable.WritableProperties {
                "attributes": Gck.Attributes
            }
        ...
        namespace SimpleCertificate {
            ...
            interface ReadableProperties extends GObject.Object.ReadableProperties, Certificate.ReadableProperties, Comparable.ReadableProperties {
            }

            interface WritableProperties extends GObject.Object.WritableProperties, Certificate.WritableProperties, Comparable.WritableProperties {
            }
        ...
        const SimpleCollection: SimpleCollectionClass
        ...
        const UnionCollection: UnionCollectionClass
        none
        /**
         */
        ...
        abstract class Column {
            static readonly $gtype: GObject.GType<Column>
        ...
        abstract class FilterCollectionPrivate {
            static readonly $gtype: GObject.GType<FilterCollectionPrivate>
        ...
        abstract class SimpleCollectionPrivate {
            static readonly $gtype: GObject.GType<SimpleCollectionPrivate>
        ...
        abstract class UnionCollectionPrivate {
            static readonly $gtype: GObject.GType<UnionCollectionPrivate>
        ...
        const ICON_CERTIFICATE: "application-certificate"
        const ICON_GNUPG: "gcr-gnupg"
        const ICON_HOME_DIRECTORY: "user-home"
        const ICON_KEY: "gcr-key"
        const ICON_KEY_PAIR: "gcr-key-pair"
        const ICON_PASSWORD: "gcr-password"
        const ICON_SMART_CARD: "gcr-smart-card"
        ...
        namespace ColumnFlags {
            const $gtype: GObject.GType<ColumnFlags>
        }
