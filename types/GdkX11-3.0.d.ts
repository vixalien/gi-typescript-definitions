...
declare module "gi://GdkX11?version=3.0" {
    ...
    namespace GdkX11 {
        ...
        interface X11Display extends Gdk.Display {
             ...
             * @since 2.8
             * @param theme the name of the cursor theme to use, or %NULL to unset
             ...
             * @since 2.24
             * @param encoding an atom representing the encoding. The most
        ...
        interface X11Window extends Gdk.Window {
             ...
             * @since 3.4
             * @param hide_titlebar_when_maximized whether to hide the titlebar when
                                           maximized
             */
