    ...
    namespace Json {
        ...
        namespace Parser {
            interface SignalSignatures extends GObject.Object.SignalSignatures {
                 ...
                 * @deprecated since 1.10 Derive your own parser type from `JsonParser` and   override the [vfunc@Json.Parser.array_element] virtual function
                 ...
                 * @deprecated since 1.10 Derive your own parser type from `JsonParser` and   override the [vfunc@Json.Parser.array_end] virtual function
                 ...
                 * @deprecated since 1.10 Derive your own parser type from `JsonParser` and   override the [vfunc@Json.Parser.array_start] virtual function
                 */
                "array-start"(): void
                /**
                 * The `::error` signal is emitted each time a parser encounters
                 * an error in a JSON stream.
                 * @deprecated since 1.10 Derive your own parser type from `JsonParser` and   override the [vfunc@Json.Parser.error] virtual function
                 ...
                 * @deprecated since 1.10 Derive your own parser type from `JsonParser` and   override the [vfunc@Json.Parser.object_end] virtual function
                 ...
                 * @deprecated since 1.10 Derive your own parser type from `JsonParser` and   override the [vfunc@Json.Parser.object_member] virtual function
                 ...
                 * @deprecated since 1.10 Derive your own parser type from `JsonParser` and   override the [vfunc@Json.Parser.object_start] virtual function
                 */
                "object-start"(): void
                /**
                 * This signal is emitted when a parser successfully finished parsing a
                 * JSON data stream.
                 * @deprecated since 1.10 Derive your own parser type from `JsonParser` and   override the [vfunc@Json.Parser.parse_end] virtual function
                 */
                "parse-end"(): void
                /**
                 * This signal is emitted when a parser starts parsing a JSON data stream.
                 * @deprecated since 1.10 Derive your own parser type from `JsonParser` and   override the [vfunc@Json.Parser.parse_start] virtual function
                 */
                "parse-start"(): void
            }
        ...
        abstract class Object {
             ...
             * with the same name.
             * @deprecated since 0.8 Use [method@Json.Object.set_member] instead
             * @param member_name the name of the member
