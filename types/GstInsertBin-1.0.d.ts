    ...
    namespace GstInsertBin {
        ...
        namespace InsertBin {
            interface SignalSignatures extends Gst.Bin.SignalSignatures, Gst.ChildProxy.SignalSignatures {
                 ...
                 * @since 1.2
                 * @param callback the callback to call when the element has been added or not, or
                 %NULL
                 ...
                 * @since 1.2
                 * @param callback the callback to call when the element has been removed or not,
                or %NULL
                 * @param user_data The data to pass to the callback
                 * @param user_data2 The user data of the signal (ignored)
                 */
