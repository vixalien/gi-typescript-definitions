    ...
    namespace Atspi {
        ...
        namespace Accessible {
            interface SignalSignatures extends Object.SignalSignatures, Action.SignalSignatures, Collection.SignalSignatures, Component.SignalSignatures, Document.SignalSignatures, EditableText.SignalSignatures, Hypertext.SignalSignatures, Image.SignalSignatures, Selection.SignalSignatures, Table.SignalSignatures, TableCell.SignalSignatures, Text.SignalSignatures, Value.SignalSignatures {
                 ...
                 * @param arg1 an integer specifying the current offset of the text being read,
                       if the object is textual.
                 * @param arg2 an integer specifying the ending offset of the text being read,
                       if the object is textual.
                 */
        ...
        namespace Device {
            interface SignalSignatures extends GObject.Object.SignalSignatures {
                 ...
                 * @param accessible The accessible from which the
        ...
        interface Device extends GObject.Object {
             ...
             * @param x a #gint indicating the x coordinate of the mouse event, relative to
                @obj..
             * @param y a #gint indicating the y coordinate of the mouse event, relative to
                @obj..
            ...
            /**
             * @since 2.60
             * @param capabilities A bitmask specifying the capabilities that should be enabled.
        ...
        interface EventListener extends GObject.Object {
             ...
             * @param properties a list of
                        properties that should be sent along with the event. The
                        properties are valued for the duration of the event callback.
             * @param app the application whose events should be reported, or
        ...
        interface EventListenerClass extends Omit<GObject.ObjectClass, "new"> {
             ...
             * event type.
             * @throws {GLib.Error}
             * @param callback the #AtspiEventListenerCB
        ...
        interface MatchRuleClass extends Omit<GObject.ObjectClass, "new"> {
             ...
             * @param states An #AtspiStateSet specifying the states to match or
                     NULL if none.
             * @param statematchtype An #AtspiCollectionMatchType specifying how to interpret
                             @states.
             * @param attributes A #GHashTable
                         ...
                         backslash.
             * @param attributematchtype An #AtspiCollectionMatchType specifying how to
                     interpret @attributes.
             * @param roles A #GArray of roles to match,
                    or NULL if not applicable.
             * @param rolematchtype An #AtspiCollectionMatchType specifying how to
                            interpret @roles.
             * @param interfaces An array of interfaces to
             ...
             * @param interfacematchtype An #AtspiCollectionMatchType specifying how to
                                 interpret @interfaces.
             * @param invert if #TRUE, the match rule should be denied (inverted); if #FALSE,
        ...
        interface StateSet extends GObject.Object {
             ...
             * @param state an #AtspiStateType for which the specified #AtspiStateSet
                     will be queried.
             ...
             * @param enabled if #TRUE, @name should be enabled in the @set in question;
        ...
        interface StateSetClass extends Omit<GObject.ObjectClass, "new"> {
             ...
             * @param states An array of states with which the
         ...
         * @param stroke The #AtspiDeviceEvent for which notification is
          being received.
