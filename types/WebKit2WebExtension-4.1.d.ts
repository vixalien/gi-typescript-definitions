    ...
    namespace WebKit2WebExtension {
        ...
        namespace WebFormManager {
            interface SignalSignatures extends GObject.Object.SignalSignatures {
                 ...
                 * @param target_frame the #WebKitFrame containing the form's target,
        ...
        namespace WebPage {
            interface SignalSignatures extends GObject.Object.SignalSignatures {
                 ...
                 * @param step a #WebKitFormSubmissionEventType indicating the current
                stage of form submission
                 * @param source_frame the #WebKitFrame containing the form to be
                submitted
                 * @param target_frame the #WebKitFrame containing the form's target,
                which may be the same as @source_frame if no target was specified
                 * @param text_field_names names of
                the form's text fields
                 * @param text_field_values values
