...
declare module "gi://GIRepository?version=2.0" {
    ...
    namespace GIRepository {
        ...
        abstract class BaseInfo {
            static readonly $gtype: GObject.GType<BaseInfo>
        ...
        abstract class RepositoryPrivate {
            static readonly $gtype: GObject.GType<RepositoryPrivate>
        ...
        abstract class UnresolvedInfo {
            static readonly $gtype: GObject.GType<UnresolvedInfo>
         ...
         * @param throws TODO
         */
        function callable_info_invoke(info: CallableInfo, func: never | null, in_args: Argument[], out_args: Argument[], return_value: Argument, is_method: boolean, throws: boolean): boolean
        /**
         * s,
         ...
         * @returns %TRUE if there are more attributes, a #GIAttributeIter structure, must be initialized; see below, Returned name, must not be freed, Returned name, must not be freed
         */
        function callable_info_iterate_return_attributes(info: CallableInfo): [boolean, AttributeIter, string, string]
        /**
         ...
         */
        function type_info_argument_from_hash_pointer(info: TypeInfo, hash_pointer: never | null, arg: Argument): void
        /**
         ...
         */
        function type_info_hash_pointer_from_argument(info: TypeInfo, arg: Argument): never | null
        /**
         ...
         * @param arg A #GIArgument to fill in
         */
        function type_tag_argument_from_hash_pointer(storage_type: TypeTag, hash_pointer: never | null, arg: Argument): void
        /**
         * GLib data structures, such as #GList, #GSList, and #GHashTable, all store
         * data pointers.
         * In the case where the list or hash table is storing single types rather than
         ...
         */
        function vfunc_info_get_address(info: VFuncInfo, implementor_gtype: (GObject.GType | { $gtype: GObject.GType })): never | null
        /**
        ...
        namespace InfoType {
            const $gtype: GObject.GType<InfoType>
        }
        ...
        namespace nvokeError {
            const $gtype: GObject.GType<nvokeError>
        }
