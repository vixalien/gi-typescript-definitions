...
declare module "gi://PangoFT2?version=1.0" {
    ...
    namespace PangoFT2 {
        ...
        interface FontMap extends PangoFc.FontMap, Gio.ListModel {
             ...
             * @since 1.2
             * @deprecated since 1.46 Use [method@PangoFc.FontMap.set_default_substitute] instead.
             * @param func function to call to to do final config tweaking
             ...
             * @since 1.2
             * @deprecated since 1.46 Use [method@PangoFc.FontMap.substitute_changed] instead.
             */
