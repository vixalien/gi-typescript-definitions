...
declare module "gi://GdkX11?version=4.0" {
    ...
    namespace GdkX11 {
        ...
        interface X11Display extends Gdk.Display {
             ...
             * @param theme the name of the cursor theme to use, or %NULL
             ...
             * @deprecated since 4.18
             * @param encoding a string representing the encoding. The most
              common values for this are "STRING", or "COMPOUND_TEXT".
              This is value used as the type for the property
             * @param format the format of the property
             * @param text The text data
             * @param length The number of items to transform
             * @param list location to store an  array of strings in
        ...
        interface X11DisplayClass extends Omit<Gdk.DisplayClass, "new"> {
             ...
             * returned.
             * @deprecated since 4.18
             * @param display_name name of the X display.
        ...
        interface X11SurfaceClass extends Omit<Gdk.SurfaceClass, "new"> {
             ...
             * @deprecated since 4.18
             * @param display the `GdkDisplay` corresponding to the
              window handle
        ...
        const X11Surface: X11SurfaceClass
        none
        none
        none
        none
         ...
         * @deprecated since 4.18
         * @param surface a `GdkSurface`, used for communication
        ...
        namespace X11DeviceType {
            const $gtype: GObject.GType<X11DeviceType>
        }
