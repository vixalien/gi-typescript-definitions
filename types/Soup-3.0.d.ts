...
declare module "gi://Soup?version=3.0" {
    ...
    namespace Soup {
        ...
        interface AuthClass extends Omit<GObject.ObjectClass, "new"> {
             ...
             * yourself.
             * @param type the type of auth to create (a subtype of [class@Auth])
             * @param msg the #SoupMessage the auth is being created for
             * @param auth_header the WWW-Authenticate/Proxy-Authenticate header
             * @returns the new [class@Auth], or %NULL if it could   not be created
             */
         ...
         * @param domain a #SoupAuthDomain
         * @param msg the [class@ServerMessage] being authenticated
