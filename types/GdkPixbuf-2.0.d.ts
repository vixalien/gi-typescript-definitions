...
declare module "gi://GdkPixbuf?version=2.0" {
    ...
    namespace GdkPixbuf {
        ...
        interface PixbufClass extends Omit<GObject.ObjectClass, "new"> {
             ...
             * program's C source.
             * @deprecated since 2.44 Use [ctor@GdkPixbuf.Pixbuf.new_from_stream] with   a [class@Gio.MemoryInputStream], making sure to handle errors in   case the XPM format loader is not available
