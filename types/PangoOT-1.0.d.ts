...
declare module "gi://PangoOT?version=1.0" {
    ...
    namespace PangoOT {
        ...
        interface Info extends GObject.Object {
             ...
             * @param language_index the index of the language whose features are searched,
             ...
             * @param language_index the index of the language to list features for, or
        ...
        interface Ruleset extends GObject.Object {
             ...
             * @param property_bit the property bit to use for this feature. Used to
        ...
        abstract class Buffer {
             ...
             * fonts.
             * @since 1.6
             * @param zero_width_marks %TRUE if characters with a mark class should
